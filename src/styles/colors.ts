...
// Example: background: colors.gray[200]
...
// Helper function to get a color with TypeScript support
export const getColor = (family: ColorFamily, shade?: ColorShade): string => {
  ...
  if (shade && colorFamily && typeof colorFamily === 'object') {
